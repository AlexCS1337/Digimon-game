...
Koromon_idle = [pygame.image.load("images/mos.png")]
	...
	for event in pygame.event.get():	# User did something
		...
		if event.type == pygame.MOUSEBUTTONDOWN:
			...
			if ( x  in range(300,320)) and ( y in range(10,30)): # if in range, add age +1 to player
				...
				print age_stat,weight_stat,strength_stat,defence_stat,speed_stat,intelligence_stat
		...
		if event.type == pygame.MOUSEBUTTONDOWN:
			x,y = event.pos # gets the x, y position of the mouse click
			if ( x  in range(320,350)) and ( y in range(10,30)): # if in range, add age +1 to player
...
############################ ALL EVENT PROCESSING SHOULD GO ABOVE THIS COMMENT #################################
	...
	if Player.age == 2 and Player.strength >= 5 and Player.defence >= 2 and Player.speed == 0 and Player.intelligence == 0: 
...
############################ ALL CODE TO DRAW SHOULD GO BELOW THIS COMMENT #################################
	...
	if draw_egg:
		screen.blit((Egg_sprites_next), (189, 130))
	
	elif draw_Koromon:
		screen.blit((Koromon_sprites_next), (x_pos,y_pos))
		
	elif draw_Leafmon:
		screen.blit((Leafmon_sprites_next), (x_pos,y_pos))
